...
<body class="bg-gray-50">
        ...
        <div class="main-content">
            ...
            <div class="empty-state fade-in">
                ...
                <div class="empty-illustration">
                   <img src="{{ asset('/assets/images/maps/location_notactive.png') }}" alt="AMIKOM Yogyakarta" />
                </div>
                
                <!-- Text Content -->
                <div class="empty-content">
                    <h2 class="empty-title">Lokasi Belum Aktif</h2>
                    <p class="empty-description">
                        Nyalakan GPS untuk melihat mesin di sekitarmu
                    </p>
                </div>
    ...
    <script>
        ...
        function searchAgain() {
            ...
            button.innerHTML = '<i class="fas fa-spinner fa-spin"></i><span>Mengaktifkan...</span>';
