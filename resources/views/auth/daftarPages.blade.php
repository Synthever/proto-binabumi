...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/auth/daftarPages.css') }}">
...
<body class="login-container">
    <div class="main-content">
        ...
        <div class="title-section">
            ...
            <p class="subtitle">Silahkan daftarkan akun Anda</p>
        </div>
        ...
        <div class="register-section">
            <p class="register-text">
                Sudah punya akun? <a href="/login" class="register-link">Masuk sekarang!</a>
            </p>
        </div>
    </div>
</body>
